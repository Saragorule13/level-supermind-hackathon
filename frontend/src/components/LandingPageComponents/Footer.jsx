const Footer = () => {
    return (
      <section id="footer" className="bg-neutral-900 text-gray-300">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-white">SoulBuddy</h3>
              <p className="text-sm">
                Your AI-powered spiritual companion for personalized guidance through astrology and numerology.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#" className="hover:text-white">Spiritual Guidance</a></li>
